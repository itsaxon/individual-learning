...
// 静态导入所有主题视图（替代 import.meta.glob，使项目可作为纯静态文件部署）
import themesThemes from './themes/themes.js'
import themesLoading from './themes/loading.js'
import themesSaveload from './themes/saveload.js'
import themesMessage from './themes/message.js'
import themesCyberTrajectory from './themes/cyber/trajectory.js'
import themesCyberTalent from './themes/cyber/talent.js'
import themesCyberSummary from './themes/cyber/summary.js'
import themesCyberProperty from './themes/cyber/property.js'
import themesCyberCelebrity from './themes/cyber/celebrity.js'
import themesCyberAchievement from './themes/cyber/achievement.js'
import themesCyberMain from './themes/cyber/main.js'
import themesCyberMode from './themes/cyber/mode.js'
import themesCyberPopupAchievementPopup from './themes/cyber/popup/achievementPopup.js'
import themesDefaultTrajectory from './themes/default/trajectory.js'
import themesDefaultThanks from './themes/default/thanks.js'
import themesDefaultTalent from './themes/default/talent.js'
import themesDefaultSummary from './themes/default/summary.js'
import themesDefaultProperty from './themes/default/property.js'
import themesDefaultAchievement from './themes/default/achievement.js'
import themesDefaultCelebrity from './themes/default/celebrity.js'
import themesDefaultMain from './themes/default/main.js'
import themesDefaultMode from './themes/default/mode.js'
import themesDefaultPopupAchievementPopup from './themes/default/popup/achievementPopup.js'

// 构造与 import.meta.glob 相同结构的映射：path → loader 函数
const __themeViews = {
    './themes/themes.js': () => Promise.resolve({ default: themesThemes }),
    './themes/loading.js': () => Promise.resolve({ default: themesLoading }),
    './themes/saveload.js': () => Promise.resolve({ default: themesSaveload }),
    './themes/message.js': () => Promise.resolve({ default: themesMessage }),
    './themes/cyber/trajectory.js': () => Promise.resolve({ default: themesCyberTrajectory }),
    './themes/cyber/talent.js': () => Promise.resolve({ default: themesCyberTalent }),
    './themes/cyber/summary.js': () => Promise.resolve({ default: themesCyberSummary }),
    './themes/cyber/property.js': () => Promise.resolve({ default: themesCyberProperty }),
    './themes/cyber/celebrity.js': () => Promise.resolve({ default: themesCyberCelebrity }),
    './themes/cyber/achievement.js': () => Promise.resolve({ default: themesCyberAchievement }),
    './themes/cyber/main.js': () => Promise.resolve({ default: themesCyberMain }),
    './themes/cyber/mode.js': () => Promise.resolve({ default: themesCyberMode }),
    './themes/cyber/popup/achievementPopup.js': () => Promise.resolve({ default: themesCyberPopupAchievementPopup }),
    './themes/default/trajectory.js': () => Promise.resolve({ default: themesDefaultTrajectory }),
    './themes/default/thanks.js': () => Promise.resolve({ default: themesDefaultThanks }),
    './themes/default/talent.js': () => Promise.resolve({ default: themesDefaultTalent }),
    './themes/default/summary.js': () => Promise.resolve({ default: themesDefaultSummary }),
    './themes/default/property.js': () => Promise.resolve({ default: themesDefaultProperty }),
    './themes/default/achievement.js': () => Promise.resolve({ default: themesDefaultAchievement }),
    './themes/default/celebrity.js': () => Promise.resolve({ default: themesDefaultCelebrity }),
    './themes/default/main.js': () => Promise.resolve({ default: themesDefaultMain }),
    './themes/default/mode.js': () => Promise.resolve({ default: themesDefaultMode }),
    './themes/default/popup/achievementPopup.js': () => Promise.resolve({ default: themesDefaultPopupAchievementPopup }),
}
